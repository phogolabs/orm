...
func (g *GatewayTx) All(ctx context.Context, q sql.Statement, v interface{}) error {
...
// sql.Result.
func (g *GatewayTx) Exec(ctx context.Context, q sql.Statement) (sql.Result, error) {
